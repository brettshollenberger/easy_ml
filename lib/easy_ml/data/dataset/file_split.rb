  ...
  module Data
    class Dataset
      class FileSplit < Split
        ...
        attr_accessor :dir, :polars_args, :max_rows_per_file, :batch_size, :sample, :verbose

        def initialize(dir: nil, polars_args: {}, max_rows_per_file: 1_000_000, batch_size: 10_000, sample: 1.0,
                       verbose: false)
          @dir = dir
