    ...
    module Migration
      class MigrationGenerator < Rails::Generators::Base
        ...
        def create_migration_files
          ...
          create_easy_ml_dataset_statistics_migration
        end
        ...
        def create_easy_ml_dataset_statistics_migration
          migration_template(
            "create_easy_ml_dataset_statistics.rb.tt",
            "db/migrate/create_easy_ml_dataset_statistics.rb"
          )
        end
